...
function Board3Players() {
  // DUMMY BOARDS
  let alphabeth = "_ABCDEFGHIJKLMNOPQRST"
      ...
      <div className="container row justify-content-center">
        {
          boards.map((row, rowIdx) => {
            return <div key={rowIdx} className="d-flex flex-wrap" style={{width: "840px"}}>
                {
